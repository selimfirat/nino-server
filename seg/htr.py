...
# TODO have trainer, loader, validator etc. classes taking TextRecognizer as argument

class TextRecognizer:
    def __init__(self, nh=256, ncl=27, lr=1e-3):
        self.nh = nh
        self.ncl = ncl
    ...
    def decode(self, l):
        ...
        return str(chr(c+ord('a')-1) for c in l if c != 0)
